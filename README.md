...
- **Sidebar pin** — a panel icon next to the Chat History header keeps the chat-history panel open while you switch conversations (chat select and outside-click no longer auto-close it); click again for normal auto-close behavior, choice persists across reloads
